...
module  rom_altufm_none_2nl
	...
	defparam
		...
		maxii_ufm_block1.init_file = "rom.mif",
		maxii_ufm_block1.mem1 = 512'hC070641024206420E580E5B0EDB06400E800B41024006410E200E010E160EC70A170F200A170F100A100F480E060E060E44024006400C1E0A020C190C1A0EC00,
		...
		maxii_ufm_block1.mem16 = 512'hFFFFFFFFFFFFBFF0F040AE804FE07FE0AE806FE0AF80F100C1C0AF10C190E060AE90F480E060E460C1E0AE90C190C1A0FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF,
		maxii_ufm_block1.mem2 = 512'hFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFB410F04064102420E010EC70A2A0441044007410C0403400C07064102420A1F044104400C8107410C890C0403400,
...
module rom (
	...
	wire  sub_wire2;
	wire  sub_wire3;
	wire  drdout = sub_wire0;
	wire  busy = sub_wire1;
	wire  osc = sub_wire2;
	wire  rtpbusy = sub_wire3;

	rom_altufm_none_2nl	rom_altufm_none_2nl_component (
				.drshft (drshft),
				.erase (erase),
				.ardin (ardin),
				.arshft (arshft),
...
// Retrieval info: PRIVATE: INTERFACE_CHOICE NUMERIC "0"
